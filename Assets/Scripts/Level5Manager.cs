...
public class Level5Manager : MonoBehaviour
{
    ...
    IEnumerator RunCode()
    {
        ...
        // ТОЧНАЯ ПРОВЕРКА КОДА ДЛЯ УРОВНЯ 5
        if (code == correctCode)
        {
    ...
    void SaveProgress()
    {
        ...
        PlayerPrefs.SetInt("Level54_Passed", 1);

        // Открываем уровень 6
        PlayerPrefs.SetInt("Level6_Status", 1); // 1 = открыт
